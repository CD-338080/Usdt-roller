      ...
      <div key={categoryIndex}>
        ...
        <div className="space-y-2">
          {[...Array(3)].map((_, taskIndex) => (
            <div
              key={taskIndex}
              className="flex justify-between items-center bg-[#27391C] rounded-lg p-4"
            >
            ...
            <div className="px-4 pt-1 pb-24">
              <div className="relative mt-4">
                <div className="flex justify-center mb-4">
                  <IceCube className="w-24 h-24 mx-auto text-[#f3ba2f]" />
                </div>
                    ...
                    <div key={category}>
                      ...
                      <div className="space-y-2">
                        {categoryTasks.map((task) => (
                          <div
                            key={task.id}
                            className="flex justify-between items-center bg-[#27391C] rounded-lg p-4 cursor-pointer"
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="flex flex-col">
                                ...
                                <div className="flex items-center">
                                  ...
                                  <span className="text-[#f3ba2f]">+{formatNumber(task.points)}</span>
                                </div>
                              </div>
                            </div>
                            {task.isCompleted ? (
